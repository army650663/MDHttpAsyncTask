...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String[] fileUrls = {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContext = this;
        String url = "http://pub.mysoqi.com/ht_analy/lab/?acc=MADMANCHEN&psd=Codeing&page=meritinfo&act=meritinfo_getdata";

        HashMap<String, String> postData = new HashMap<>();
        postData.put("acc", "TH040102");
        postData.put("psd", "8737");
        postData.put("devtype", "android");
        postData.put("vercode", String.valueOf(BuildConfig.VERSION_CODE));

        new MDHttpAsyncTask.Builder()
                .load("http://public.hte.co.th/appshop/APICK.php")
